...
function static_inq_form_validate(frm) {
	...
	if (frm=="" || frm=="10001") {  //Buisness Inquiry Form
		...
		if (chktrim(document.static_form.dynFrm_education_details.value).length==0) {
			...
			jQuery('#dynFrm_education_details').parent().find('span.red').text('Please Enter Your Education Details.');
		...
		*/
	...
	else if (frm=="10031" || frm=="10032" || frm=="10033" || frm=="10034" || frm=="10035") {  //EI Contact form, REI Contact form, TTW Contact form, Quicj Inquiry
		...
		if(frm!="10032" && frm!="10034" && frm!="10035") {
		
			if((document.static_form.dynFrm_country.options[document.static_form.dynFrm_country.selectedIndex].value=="IN^91" || document.static_form.dynFrm_country.options[document.static_form.dynFrm_country.selectedIndex].value=="IN^+91") && document.static_form.dynFrm_state.options[document.static_form.dynFrm_state.selectedIndex].value=='') {
		...
		if(chktrim(document.static_form.dynFrm_phone.value).length>0) {
			...
			if((document.static_form.dynFrm_country.value=="IN^91" || document.static_form.dynFrm_country.value=="IN^+91") && (chktrim(document.static_form.dynFrm_phone.value).length<10 || chktrim(document.static_form.dynFrm_phone.value).length>10)) {
				
				jQuery('#detail_phone').parent().find('span.red').text('Please Enter Your 10 digits mobile number.')
			    document.static_form.dynFrm_phone.focus();
				return false;
			}
			else if((document.static_form.dynFrm_country.value!="IN^91" && document.static_form.dynFrm_country.value!="IN^+91") && (chktrim(document.static_form.dynFrm_phone.value).length<3 || chktrim(document.static_form.dynFrm_phone.value).length>15)) {
